...
// 分页相关
LOCALE_ZN_BEFORE_PAGE = "第";
LOCALE_ZN_AFTER_PAGE = "页    共 {pages} 页";
LOCALE_ZN_DISPLAY_MSG = "当前显示 {from} - {to} 条记录   共 {total} 条记录";

// DATAGRID相关
LOCALE_ZN_LOAD_MSG = "正在加载中...";
...
(function($) {
	...
	$.parser = {
		...
		plugins : [
		           "draggable", "droppable", "resizable", "pagination"
...
(function($) {
	...
	$.fn.pagination.defaults = {
		...
		beforePageText : LOCALE_ZN_BEFORE_PAGE,
		afterPageText : LOCALE_ZN_AFTER_PAGE,
		displayMsg : LOCALE_ZN_DISPLAY_MSG,
		nav : {
			first : {
