...
@Configuration
@MapperScan(basePackages = DataSourceERP.PACKAGE, sqlSessionTemplateRef  = DataSourceERP.DB_NAME + "SqlSessionTemplate")
public class DataSourceERP {
	static final String DB_NAME = "erp";
